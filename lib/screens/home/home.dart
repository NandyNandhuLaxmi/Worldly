  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(icon: Icon(EvaIcons.bellOutline), 
              onPressed: () {
          ...
          child: ListView(children: [
            UserAccountsDrawerHeader(
              ...
              currentAccountPicture: ClipRRect(
                ...
                child: FutureBuilder(
                    future: accounts.getprofileimages(),
                    builder: (context, snapshot) {
                      if (snapshot.data == "null") {
                        return FutureBuilder(
                            future: store.getstring("username"),
                            builder: (BuildContext context, snt) {
                              return Text(snt.data[0]);
                            });
                      }
                ...
                onTap: () {
                  showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          title: Text('Worldy', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
        ...
        body: Container(
          child: (searchvalue.isNotEmpty)?FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, idx) {
                      ...
                      return InkWell(
                        onTap:()=> Navigator.push(context, MaterialPageRoute(builder: (context)=>Details(val: snapshot.data[idx]['id']))),
                        child: Container(
