    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: FutureBuilder(
            future: accounts.privacy(privacy),
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: Text('Privacy Policy', style: TextStyle(color: Color(0xFF000000), fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                  Container(
                    padding: const EdgeInsets.all(10.0),
                    child: Text(snapshot.data['privacy'].substring(3).trim(), style: TextStyle(color: Color(0xFF000000), fontSize: 15, fontWeight: FontWeight.w500))
